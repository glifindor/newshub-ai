...
from app.services.telegram_poster import RateLimiter, TelegramPoster
...
def mock_bot():
    ...
    bot.get_me = AsyncMock(
        return_value=Mock(id=123456789, first_name="NewsHub AI", username="NewsHubBot")
    )
    return bot
...
class TestTelegramPoster:
    ...
    async def test_send_to_admin_moderation(self, mock_db, mock_bot, sample_news):
        ...
        assert (
            ...
            == poster.bot.send_message.call_args.kwargs["chat_id"]
        )
